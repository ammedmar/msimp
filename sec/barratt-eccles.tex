...
\begin{proof}
	...
	\todo{@paolo@andrea: This proof is in my opinion way too long for what it is. I suggest boiling it down to a the key elements using steps like "it can be checked that". 
 
 @anibal: Actually it is just a summary of the proof I wrote}
\end{proof}