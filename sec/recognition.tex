...
\begin{proposition}[{\cite[\S1.7]{berger1997confspacemodel}}]
...
\begin{equation}\label{eq:extended complete graph map}
	...
\end{equation}
\todo{@andrea,@paolo: We therefore have natural homotopy equivalences ??? for each r and d. @anibal what do you mean to add here?}