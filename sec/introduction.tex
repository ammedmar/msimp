...
\[
\BE(r,1) \subseteq \BE(r,2) \subseteq \dotsb
\]
introduced by Smith \cite{smith1989filtration}.\footnote{As before we disregard the operadic structure on $\set{\BE(r,d)}_{r \geq 1}$.}
