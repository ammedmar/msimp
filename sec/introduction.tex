...
Our $E_\infty$-algebra structure on this cochain complex makes the computation much simpler and faster, paving the way for an extension to higher dimensions.\todo{@paolo: is this E-infty claim OK?}
...
\chains(W(r,d)),
\]
where the second quasi-isomorphism is induced from an explicit simplicial map.\todo{@paolo: weak equivalence?}
