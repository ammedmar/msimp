...
%The vertices of $\simplex^{n_1} \times \dots \times \simplex^{n_k}$ are parameterized by
%\[
%\set[\big]{(v_1, \dots, v_n) \mid v_j \in \set{0,\dots,n_j}}
%\]
%and those in the fundamental simplex are those satisfying $v_i > \dots > v_k$.
